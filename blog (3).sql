...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 06, 2023 at 03:40 PM
...
CREATE TABLE `blog_posts` (
  ...
  `post_image2` varchar(100) DEFAULT NULL,
  `post_image3` varchar(100) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
ALTER TABLE `blog_post_category`
  MODIFY `post_cat_id` int(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
COMMIT;
